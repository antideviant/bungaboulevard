...
<html lang="en">
    <head>
        ...
        <title>BungaBoulevard | Manage Addresses</title>
        <!-- Favicon-->
...
<?php include_once('includes/header.php');?>
        <!-- Section-->
        <section class="py-5">
            <div class="container px-5  mt-5" style="max-width: 1200px;">
                <h2><strong>Listed Billing & Shipping Address</strong></h2>
<?php 
$uid=$_SESSION['id'];
      ...
      <table class="table">
            ...
            <tbody> 
                ...
                <tr>
                    ...
                    <td width="180"><?php echo $result['billingAddress'];?></td>
