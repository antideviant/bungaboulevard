...
<html lang="en">
    <head>
        ...
        <meta name="author" content="" />
         <title>BungaBoulevard | Category Wise Shop </title>
        <!-- Favicon-->
...
<?php include_once('includes/header.php');?>
        <!-- Header-->
        <header class="bg-new py-5" style="background-image: url('admin/productimages/autumn.jpg');background-repeat: no-repeat;
