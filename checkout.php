...
?>
                ...
                <tr>
                    <td class="col-md-2"><img src="admin/productimages/<?php echo htmlentities($row['pimage']);?>" alt="<?php echo htmlentities($row['pname']);?>" width="100" height="140"></td>
                    <td>
                    <a href="product-details.php?pid=<?php echo htmlentities($pd=$row['pid']);?>" style="color: hotpink;"><?php echo htmlentities($row['pname']);?></a>
        </td>
<td>
                    ...
                    <td><?php echo htmlentities($row['productQty']);?></td>
                     <td>RM <?php echo htmlentities($totalamount=$row['productQty']*$row['pprice']);?></td>
                    <td>
    ...
    <br><h5>Already Listed Addresses</h5>
    <?php 
    $uid=$_SESSION['id'];
    ...
    <?php } endif; ?>
    <div align="right">
        <button class="btn-upper btn btn-primary btn2" type="submit" name="proceedpayment">Proceed for Payment</button>
    </div>
    </form>
    <hr />
   ...
   <form method="post" name="address">
     ...
     <div class="row">
       ...
       <div class="row mt-3">
         ...
         <div class="row mt-3">
                 <div class="col-5">&nbsp;</div>
         <div class="col-6"><input type="submit" name="submit" id="submit" class="btn btn-primary btn2" value="Add" required></div>
     </div>
