...
<div id="layoutSidenav_nav">
    <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion" style="background-color: #654321;">
...
<a class="nav-link" href="outfordelivery-orders.php">Out for Delivery Order <span style="color:#fff"> [<?php echo $otforders;?>]</span></a>
...
<div class="sb-sidenav-menu-heading">Reports and Users</div>

                <!--Categories --->
                <a class="nav-link collapsed" href="#" data-bs-toggle="collapse" data-bs-target="#reportsLayouts" aria-expanded="false" aria-controls="collapseLayouts">
                    <div class="sb-nav-link-icon"><i class="fas fa-file"></i></div>
                    Reports
                    <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                </a>
                <div class="collapse" id="reportsLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                    <nav class="sb-sidenav-menu-nested nav">
                        <a class="nav-link" href="bwdates-ordersreport.php">Orders Report</a>
...
<a class="nav-link" href="registered-users.php">
        ...
        <div class="sb-sidenav-footer" style="background-color: #654321;">
