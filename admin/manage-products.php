...
<html lang="en">
    <head>
        ...
        <title>BungaBoulevard | Manage Products</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4"><strong>Manage Products</strong></h1>
...
?>  
                                ...
                                <tr>
                                            ...
                                            <td>
                                            <a href="edit-product.php?id=<?php echo $row['pid']?>"><i class="fas fa-edit" style="color:#8a4e2c;"></i></a> | 
                                            <a href="manage-products.php?id=<?php echo $row['pid']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')"><i class="fa fa-trash" aria-hidden="true" style="color:#de0707;"></i></a></td>
                                        </tr>
                                        <?php $cnt=$cnt+1; } ?>
