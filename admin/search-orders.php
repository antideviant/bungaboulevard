...
<html lang="en">
    <head>
        ...
        <title>BungaBoulevard | Manage Searched Orders</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4"><strong>Manage Searched Orders</strong></h1>
...
?>
<h4 align="center" style="color:brown !important;"><i>Search Result against <?php echo $searchinput;?></i></h4>
<hr />
