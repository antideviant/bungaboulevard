...
<html lang="en">
    <head>
        ...
        <meta name="author" content="" />
         <title>BungaBoulevard | Update Image 2</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                   <div class="container-fluid px-4">
                        <h1 class="mt-4"><strong>Update Image 2</strong></h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="dashboard.php" style="color: brown;">Dashboard</a></li>
                            <li class="breadcrumb-item active">Update Image 2</li>
                        </ol>
                       
                        <div class="container custom-container" style="padding: 5%; padding-top: 0; padding-bottom: 0;">
                           <div class="login-box">
                            <!-- /.login-logo -->
                            <div class="card card-outline card-primary" style="height: 730px; margin: 10%; padding: 2%; border: 2px solid #c28163; border-radius: 10px; box-shadow: 0px 0px 5px #c28163;">
                            <div class="card-body">
...
?>                                 
            <form  method="post" enctype="multipart/form-data">                                
                    ...
                    <div class="row" style="margin-top:2%;">
                    <div class="col-3">Product Featured Image</div>
                    <div class="col-6"><input type="file" name="productimage2" id="productimage2"  class="form-control" accept="image/*" title="Accept images only" required>
                    </div>
                    </div>
