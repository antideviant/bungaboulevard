...
<html lang="en">
    <head>
        ...
        <meta name="author" content="" />
         <title>BungaBoulevard | Order Details</title>
...
<!-- Products / Item Details --->
 <div class="col-12">
        <table class="table table-bordered" border="1">
                                        <tr>
                                            <th colspan="6" style="text-align:center;">Products Details</th>
                                        </tr>
                                        <tr>
                                            <th>Product</th>
                                            <th>Product Name</th>
...
?>  
             ...
             <tr>
                    <td><img src="productimages/<?php echo htmlentities($row['productImage1']);?>" alt="<?php echo htmlentities($row['productName']);?>" width="100" height="140"></td>
                    <td>
                       <a href="edit-product.php?id=<?php echo htmlentities($pd=$row['pid']);?>" target="_blank" style="color: brown;"><?php echo htmlentities($row['productName']);?></a>
        </td>
<td>RM <?php echo htmlentities($row['productPrice']);?></td>
                    <td><?php echo htmlentities($row['quantity']);?></td>
                     <td>RM <?php echo htmlentities($totalamount=$row['quantity']*$row['productPrice']);?></td>
                        <td>RM <?php echo htmlentities($tshipping=$row['shippingCharge']);?></td>
...
<tr>
    ...
    <th>RM <?php echo htmlentities(round($grandtotalamount,2));?></th>
    <th>RM <?php echo htmlentities(round($grandtshipping,2));?></th>
</tr>
<tr>
    <th colspan="4" style="text-align:right;">Grand-Total</th>
    <th colspan="2" style="text-align:center;">RM <?php echo htmlentities(round($grandtotalamount+$grandtshipping,2));?></th>
</tr>
                                </table></div>
...
<div align="center"><button class="btn btn-info btn-block btn1" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal">Take Action</button>
</div>
<?php endif;?>


<div style="float:right;">
  <button class="btn btn-info btn-block btn1" style="cursor: pointer;"  OnClick="CallPrint(this.value)" >Print</button></div>
                            </div>
                            </div>
                        </div>
                    </div>
...
<textarea class="form-control" required name="remark" placeholder="Remark"></textarea></p>
            ...
            <div class="modal-footer"><button class="btn btn-secondary" type="button" data-bs-dismiss="modal">Close</button>
                <button class="btn btn-info btn-block btn1" type="submit" name="takeaction">Save changes</button></div>
        </div>
    </form>
    </div>
</div>
