...
<html lang="en">
    <head>
        ...
        <title>BungaBoulevard | Manage Sub-Categories</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4"><strong>Manage Sub-Categories</strong></h1>
...
?>  
                                ...
                                <tr>
                                            ...
                                            <td>
                                            <a href="edit-subcategory.php?id=<?php echo $row['subid']?>"><i class="fas fa-edit" style="color:#8a4e2c;"></i></a> | 
                                            <a href="manage-subcategories.php?id=<?php echo $row['subid']?>&del=delete" onClick="return confirm('Are you sure you want to delete?')"><i class="fa fa-trash" aria-hidden="true" style="color:#de0707;"></i></a></td>
                                        </tr>
                                        <?php $cnt=$cnt+1; } ?>
