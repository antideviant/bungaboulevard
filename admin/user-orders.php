...
<html lang="en">
    <head>
        ...
        <title>BungaBoulevard | User Orders</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    ...
                    <div class="container-fluid px-4">
                        <h1 class="mt-4"><strong>Manage <?php echo  $username;?>'s Orders</strong></h1>
...
<style type="text/css">
    .pink-icon {
        color: #cf8d88; /* Modify this value to adjust the pink color */
    }
</style>
